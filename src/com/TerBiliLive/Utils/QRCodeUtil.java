...
//        String file = new Random().nextInt(99999999)+".jpg";
     ...
     * @throws Exception
     */
    public static String buildLoginQr(String text) throws Exception {
        String logoPath = null;
        String destPath = "Ter/cache/";
        System.out.println();
        return "Ter/cache/" + QRCodeUtil.encode(text, logoPath, destPath, true);
    }
